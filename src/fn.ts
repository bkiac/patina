...
export function fn<A extends any[], R extends Result<Result<Result<any, any>, any>, any>>(
	f: (...args: A) => R,
): (
	...args: A
) => Result<
	Result<
		Result<ExtractOk<InferOk<InferOk<R>>>, ExtractErr<InferOk<InferOk<R>>>>,
		ExtractErr<InferOk<R>>
	>,
	InferErr<R>
>
